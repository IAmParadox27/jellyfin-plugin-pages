    ...
    public class StartupService : IScheduledTask
    {
        ...
        public async Task ExecuteAsync(IProgress<double> progress, CancellationToken cancellationToken)
        {
...

            {
                ...
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/IndexHtml");
            ...
            
            {
                ...
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/UserPlugin/SettingsHtml");
            ...
            
            {
                ...
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/UserPlugin/Javascript");
            ...
            
            {
                ...
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/UserPlugin/IndexHtmlChunk");
            ...
            
            {
                ...
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/MainBundle/PluginSettingsRoute");
            ...
            
            {
                ...
                payload.Add("fileNamePattern", "main.jellyfin.bundle.js");
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/MainBundle/RouteIds");
            ...
            
            {
                ...
                payload.Add("tranformationEndpoint", "/PluginPages/Patch/RuntimeBundle");
