...
public class Plugin : BasePlugin<BasePluginConfiguration>
{
    ...
    public Plugin(IApplicationPaths applicationPaths, IXmlSerializer xmlSerializer, ILogger<Plugin> logger,
        IServerConfigurationManager configurationManager, IPluginPagesManager pluginPagesManager,
        IServerApplicationHost appHost, IServiceProvider serviceProvider) : base(applicationPaths, xmlSerializer)
    {
